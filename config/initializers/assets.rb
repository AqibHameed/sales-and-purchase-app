...
Rails.application.config.assets.precompile += %w( images_vid/user.svg )
Rails.application.config.assets.precompile += %w( images_vid/ic_remove.svg )
Rails.application.config.assets.precompile += %w( images_vid/loader2.gif )
Rails.application.config.assets.precompile += %w( img/loader2.gif )
