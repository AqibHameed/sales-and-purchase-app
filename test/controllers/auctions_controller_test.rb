...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post auctions_url, params: { auction: { min_bid: @auction.min_bid, tender_id: @auction.tender_id, time: @auction.time } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { min_bid: @auction.min_bid, tender_id: @auction.tender_id, time: @auction.time } }
