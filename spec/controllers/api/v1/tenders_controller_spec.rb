...
RSpec.describe Api::V1::TendersController do
  ...
  describe '#tender_index' do
    ...
    context 'when authorized  tender access the api' do
      it 'get the tender according to loation' do
    ...
    context 'when authorized  tender access the api' do
      it 'get the tender according to month' do
    ...
    context 'when authorized  tender access the api' do
      it 'get the tender according to supplier_id' do
    ...
    context 'when authorized  tender access the api' do
      it 'get the tender according to upcoming' do
        tender = create(:tender, supplier: @supplier, open_date:  DateTime.now + 1, close_date:  DateTime.now + 2)
        get :index
    ...
    context 'when authorized  tender access the api' do
      it 'get the tender according to past' do
